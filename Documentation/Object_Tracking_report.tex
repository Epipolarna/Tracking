...
\lstset{
	...
	commentstyle=\itshape\color{green!40!black},	% Comment color
...
\lstinputlisting{code_files/frame.h}
\newpage
\lstinputlisting{code_files/frame.cpp}
...
\lstinputlisting{code_files/object.h}

\newpage
\section{Source code for Kalman prediction}
\label{sec:Kalman_code}
\lstinputlisting{code_files/object.cpp}
